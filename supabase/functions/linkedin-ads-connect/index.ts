...
Deno.serve(async (req) => {
  if (req.method === "OPTIONS") {
    ...
    console.log(JSON.stringify({ ts: new Date().toISOString(), fn: "linkedin-ads-connect", method: req.method, connection_id: null }));
  ...
  try {
    ...
    authUrl.searchParams.set("scope", "r_ads r_ads_reporting");
