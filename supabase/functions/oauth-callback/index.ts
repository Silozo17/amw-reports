...
Deno.serve(async (req) => {
  if (req.method === "OPTIONS") {
    ...
    console.log(JSON.stringify({ ts: new Date().toISOString(), fn: "oauth-callback", method: req.method, connection_id: null }));
  ...
  let frontendUrl = "https://amwreports.com";
  let connectionId = "";
  let platform = "";
  ...
  try {
    if (platform === "google_ads") {
      ...
      await handleLinkedInAds(supabase, authCode, connectionId, supabaseUrl);
