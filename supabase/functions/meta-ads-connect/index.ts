...
Deno.serve(async (req) => {
  ...
  try {
    ...
    authUrl.searchParams.set("scope", "pages_show_list,pages_read_engagement,pages_manage_ads,read_insights,instagram_basic,instagram_manage_insights,ads_read,ads_management,business_management,leads_retrieval");
