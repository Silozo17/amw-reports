...
Deno.serve(async (req) => {
  ...
  try {
    ...
    authUrl.searchParams.set("scope", "ads_read,pages_show_list,pages_read_engagement,pages_read_user_content,pages_manage_metadata,business_management,instagram_basic");
