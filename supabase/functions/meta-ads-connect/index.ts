...
Deno.serve(async (req) => {
  ...
  try {
    ...
    authUrl.searchParams.set("scope", "ads_read,ads_management,pages_show_list,pages_read_engagement,business_management,instagram_basic,instagram_manage_insights,instagram_manage_contents,instagram_manage_comments");
